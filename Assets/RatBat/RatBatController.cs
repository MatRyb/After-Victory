...
public class RatBatController : MonoBehaviour
{
    private Vector2 lastPos;
    private Vector2 motionDirection;
    private RatBatSpriteController spriteController;

    // Start is called before the first frame update
    void Start()
    {
        spriteController = GetComponentInChildren<RatBatSpriteController>();
    }
